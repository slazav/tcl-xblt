...
package ifneeded xBlt 3.1 [list source [file join $dir main.tcl]]\n[list tclPkgSetup $dir xBlt 3.1 {
    ...
    {xcomments.tcl  source {xblt::xcomments\
            xblt::xcomments::create xblt::xcomments::create_int\
            xblt::xcomments::delete xblt::xcomments::delete_int\
            xblt::xcomments::delete_range xblt::xcomments::clear\
            xblt::xcomments::hide_all xblt::xcomments::show_all}}
}]
